...
parser.add_argument('--data_path', type=str, default='FineT_B04.csv', help='data file')
...
parser.add_argument('--label_value', type=float, default='1',help='label value for rainfall')
...
data_parser = {
    ...
    'JFNG_data_5min':{'data':'JFNG_data_5min.csv','T':'tp','M':[6,6,6],'S':[1,1,1],'MS':[6,6,1]},
    'hkws_3_5':{'data':'hkws_3_5.csv','T':'tp','M':[5,5,5],'S':[1,1,1],'MS':[5,5,1]},
    'JFNG_data':{'data':'JFNG_data.csv','T':'tp','M':[6,6,6],'S':[1,1,1],'MS':[6,6,1]},
    'hkws_4_5':{'data':'hkws_4_5.csv','T':'tp','M':[5,5,5],'S':[1,1,1],'MS':[5,5,1]},
    'JFNG_data_15min_unrh':{'data':'JFNG_data_15min_unrh.csv','T':'tp','M':[5,5,5],'S':[1,1,1],'MS':[5,5,1]},
    'JFNG_data_15min_unsp':{'data':'JFNG_data_15min_unsp.csv','T':'tp','M':[5,5,5],'S':[1,1,1],'MS':[5,5,1]},
    'JFNG_data_15min_unt2m':{'data':'JFNG_data_15min_unt2m.csv','T':'tp','M':[5,5,5],'S':[1,1,1],'MS':[5,5,1]},
    'JFNG_data_15min_unwind':{'data':'JFNG_data_15min_unwind.csv','T':'tp','M':[5,5,5],'S':[1,1,1],'MS':[5,5,1]},
    'JFNG_data_15min_handle':{'data':'JFNG_data_15min_handle.csv','T':'tp','M':[6,6,6],'S':[1,1,1],'MS':[6,6,1]},
    'JFNG_data_15min_1year':{'data':'JFNG_data_15min_1year.csv','T':'tp','M':[6,6,6],'S':[1,1,1],'MS':[6,6,1]},
    # 'JFNG_data_1h':{'data':'JFNG_data_1h.csv','T':'tp','M':[6,6,6],'S':[1,1,1],'MS':[6,6,1]},
    'JFNG_data_15min': {'data': 'FineT_B04.csv', 'T': 'tp', 'M': [6, 6, 6], 'S': [1, 1, 1], 'MS': [6, 6, 1]}
}
...
for ii in range(args.itr):
    ...
    # print('>>>>>>>fintune : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
    # exp.finetuen(setting)
    # print('>>>>>>>test : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
    # exp.tune_test(setting)
    print('>>>>>>>predict : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
    exp.tune_predict(setting)
